	...
	<div id="main-container">
		<div id="breadcrumb">
			<ul class="breadcrumb">
				...
				<li class="active">Voir Utilisateur</li>
			</ul>
		</div><!-- /breadcrumb-->
		<div class="padding-md">
			...
			<div class="panel panel-default">
				<form action="#" class="no-margin" id="formValidate1" data-validate="parsley"
					  novalidate method="#">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group has-success">
									...
									<select name="statuss" disabled class="form-control has-success">
										<c:choose>
											<c:when test="${voirUtilisateur.getStatut() == 1}">
							...
							<div class="col-md-6">
								<div class="form-group has-success">
									<label class="control-label">Role <span
											class="label label-warning">account</span></label>
									<select disabled name="roless" class="form-control has-success">
										<option selected>${voirUtilisateur.getRole()}</option>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input disabled type="text" name="firstNames" placeholder="First Name"
										   class="form-control input-sm" data-required="true"
										   value="${voirUtilisateur.getNom()}">
								</div><!-- /form-group -->
							</div><!-- /.col -->
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">Last Name</label>
									<input disabled type="text" name="lastNames" placeholder="Last Name"
										   class="form-control input-sm" data-required="true"
										   value="${voirUtilisateur.getPrenom()}">
								</div><!-- /form-group -->
							</div><!-- /.col -->
						</div><!-- /.row -->
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input disabled type="text" id="phone" name="phoneEmails" placeholder="Username"
										   class="form-control input-sm" data-required="true"
										   data-minlength="8" value="${voirUtilisateur.getPhone()}">
								</div>
							</div><!-- /.col -->
							<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input disabled type="text" name="matricules" placeholder="username"
								   class="form-control input-sm" data-required="true"
