...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>${User.getUserName()}|Admin/Voir utilisateur</title>
					...
					<form class="no-margin" id="formValidate1" data-validate="parsley" novalidate method="post">
						...
						<div class="panel-body">
								...
								<div class="col-md-6">
									<div class="form-group has-success">
										<label class="control-label">Status <span class="label label-warning">account</span> <span class="label label-danger">required</span></label>			
											<select disabled class="form-control has-success">
												<option>Actif</option>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" disabled placeholder="First Name" value="Pilote" class="form-control input-sm" data-required="true">
									</div><!-- /form-group -->
								</div><!-- /.col -->
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">Last Name <span class="label label-danger">required</span></label>
										<input type="text" disabled value="Zebs" class="form-control input-sm" data-required="true">
									</div><!-- /form-group -->
								</div><!-- /.col -->
							</div><!-- /.row -->
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">Phone <span class="label label-danger">required</span></label>
											<input value="692077005" disabled type="text" class=" form-control input-sm phone" data-minlength="15">
									</div><!-- /form-group -->
								</div><!-- /.col -->
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">Email </label>
										<input type="text" disabled class="form-control input-sm" value="null" data-required="true" data-type="email">
									</div>
								</div><!-- /.col -->
							</div><!-- /.row -->
							...
							<div class="form-group">
								...
								<input type="text" disabled value="CM20240000" class="form-control input-sm" data-required="true">
							</div><!-- /form-group -->
