...
<html lang="en">
  <head>
    <meta charset="utf-8">
	  <title>${user.getNom()}|Admin/Ajouter utilisateurs</title>
						...
						<div class="panel-body">
							<div class="row">
								...
								<script>
									document.querySelector('select[name="status"]').addEventListener('change', function () {
										...
										// Vérifier que la valeur est "Actif" ou "Inactif"
										if (value === "Actif" || value === "Inactif") {
											this.value = value;
										} else {
											alert("La valeur doit être 'Actif' ou 'Inactif'");
							...
							<script>
								function validateInput(input) {
									// Autoriser uniquement les lettres, les tirets et les espaces
