...
@WebServlet(name = "Admission-Servlet", value = "/adm-candidatpotentiel", description = "Admission du candidat potentiel")
public class CPadmissionServlet extends HttpServlet {
        ...
        if (session != null && session.getAttribute("user") != null) {
            ...
            switch (utilisateur.getRole()) {
                ...
                case "candidatpotentiel":
                    this.getServletContext().getRequestDispatcher("/WEB-INF/views/v1/data/secure/candidatpotentiel-area/cp-admission.jsp").forward(req, resp);
                    break;
                default:
