...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>${User.getUserName()}|Admin/editProfessors</title>
  ...
  <body class="overflow-hidden">
	...
	<div id="theme-setting">
		<div class="title">
			<strong class="no-margin">Your school SChool</strong>
		</div>
		<div class="theme-box">
		...
		<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 ...
					 <li class="active"><a href="all-professors.html">Colleges</a></li>
					 <li class="active">Edit College</li>	 
				</ul>
			</div><!-- /breadcrumb-->
			<div class="padding-md">
				<a href="all-colleges.jsp" class="btn btn-success"><i class="fa fa-reply"></i> Go Back</a>
				<a href="view-college.jsp" class="btn btn-warning"><i class="fa fa-check"></i> View This College</a>
				<a class="btn btn-default"><i class="fa fa-print"></i> Print this College</a>
				<div class="panel panel-default">

					<form class="no-margin" id="formValidate1" data-validate="parsley" novalidate method="post">
                        <div class="panel-heading">
                            College General Information (Add)
                        </div>
                        <div class="panel-body">
                            <!-- College Status and Date -->
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">College ID <span class="label label-danger">required</span></label>
                                        <input type="text" placeholder="College ID" class="form-control input-sm" data-required="true" data-minlength="12">
                                    </div>
                                </div><!-- /.col -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Type of College</label>
                            ...
                            <!-- College Name and Dean/Principal -->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">College Name <span class="label label-danger">required</span></label>
                                        <input type="text" placeholder="College Name" class="form-control input-sm" data-required="true">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Dean/Principal Name</label>
                                        <input type="text" placeholder="Dean/Principal Name" class="form-control input-sm">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                            </div><!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="xx-xxx-xxx-xxxx" type="text" class=" form-control input-sm phone" data-minlength="15">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Email</label>
                                        <input type="text" class="form-control input-sm" placeholder="example@example.com" data-type="email">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                            </div><!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Address" class="form-control input-sm" data-required="true">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">City</label>
                                        <input type="text" placeholder="City" class="form-control input-sm" data-required="true">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                            </div><!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Country" class="form-control input-sm" data-required="true">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Postal Code</label>
                                        <input type="text" placeholder="Postal Code" class="form-control input-sm" data-required="true">
                                    </div><!-- /form-group -->
                                </div><!-- /.col -->
                            </div><!-- /.row -->
                    
                            <!-- About College and Logo -->
                            <div class="form-group">
                                <label class="control-label">About College</label>
                                <textarea class="form-control" rows="3"></textarea>
                            </div><!-- /form-group -->
                            <div class="form-group">
                                <label class="control-label">College Logo</label>
                        ...
                        <div class="panel-footer text-right">
                            <button type="submit" class="btn btn-success"><i class="fa fa-download"></i> Add College</button>
