...
<head>
	<meta charset="utf-8">
	<title>${user.getNom()}|Admin/Ajouter Université</title>
		...
		<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 ...
					 <li class="active"><a href="gestions-universites">Université</a></li>
					 <li class="active">Ajout Université</li>
				</ul>
			</div><!-- /breadcrumb-->
			<div class="padding-md">
				<a href="gestions-universites" class="btn btn-success"><i class="fa fa-reply"></i> Go Back</a>
				<a class="btn btn-default"><i class="fa fa-print"></i> Print Empty form</a>
